...
ZWayServerPlatform.getVDevTypeKey = function(vdev){
    ...
    if(var overrideDeviceType = ZWayServerPlatform.prototype.getTagValue(vdev, "Override.deviceType")){
    ...
    if(var overrideProbeType = ZWayServerPlatform.prototype.getTagValue(vdev, "Override.probeType")){
